    ...
    <div class="container mx-auto">
      <article>
        ...
        <p>
          ...
          <br>
          最近在看nuxt3官网的modules，偶然间看到了content模块，这是nuxt3官网推出的工具，大概研究了下后，突然有了想法，不如就通过nuxt3 +
      ...
      <article>
        ...
        <ol>
          <li>
            ...
            <p>由于content实在太方便了，所以也没额外再编写后端提供api，自然也就没数据库和CMS，不过将来有可能会改为用MongoDB，这个将来是什么时候，不知道！</p>
          </li>
        </ol>
      </article>
    </div>
